...
var Table = View.partial("<table></table>").extend(function(data) {
...
var TableRow = View.partial("<tr></tr>").extend(function(cells) {
...
var TableCell = View.partial("<table></table>").extend(function(data) {
