...
Form.RadioButtons = View.partial("<fieldset></fieldset>").extend(function(name, values) {
	...
	(values || []).forEach(function(value) {
		set.push(new Form.RadioButton(name, value));
	});
...
Form.RadioButtons.prototype.addRadioButton = function(value, labelName) {

	return this.push(new Form.RadioButton(this.name, value));
};
...
Form.Checkboxes = View.partial("<fieldset></fieldset>").extend(function(name, values) {
	...
	(values || []).forEach(function(value) {
		set.push(new Form.Checkbox(name, value));
	});
...
Form.Checkboxes.addCheckbox = function(value, labelName) {

	return this.push(new Form.Checkbox(this.name, value));
};
